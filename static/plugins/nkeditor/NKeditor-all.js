    ...
    self.clickToolbar(name, function () {
        var lang = self.lang(name + '.'),
            html = ['<div style="margin: 0px 20px;">',
                ...
                '<option value="plain">Go</option>',
                '<option value="vb">ASP/VB</option>',
                '<option value="csharp">C#</option>',
                '<option value="cpp">C/C++</option>',
                '<option value="ps">Shell</option>',
...
KindEditor.plugin('image', function (K) {
    ...
    self.plugin.imageDialog = function (options) {
        ...
        var html = [
            ...
            '<div class="row-right">',
            '<input type="text" id="remoteUrl" class="ke-input-text" data-url name="url" value="" style="width:250px;" /> &nbsp;',
            '<span class="ke-button-common ke-button-outer">',
            '<input type="button" class="ke-upload-button" id="nkLayBtn" value="' + lang.upload + '" />',
            '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + lang.viewServer + '" />',
            '</span>',
            '</div>',
            '</div>',
            ...
            '<div class="row-right">',
            '<input type="text" name="localUrl" class="ke-input-text" data-url tabindex="-1" style="width:250px;" readonly="true" /> &nbsp;',
            '<input type="button" class="ke-upload-button" id="nkLayBtn2" value="' + lang.upload + '" />',
            '</div>',
            '</div>',
            '</form>',
            '</div>',
            ...
            layui.upload.render({
                ...
                , done: function (res) {
                    ...
                    if (res.data && res.data.code === "000") {
                        K("input[data-url][name=remoteUrl]").val(NP_Config.domain + res.data.item.url);
                    }
                }
            });
        });
...
KindEditor.plugin('insertfile', function (K) {
    ...
    self.plugin.fileDialog = function (options) {
        ...
        var html = [
            ...
            '<label for="keUrl" class="row-left">' + lang.url + '：</label>',
            '<div class="row-right">',
            '<input type="text" id="keUrl" data-url name="url" class="ke-input-text" style="width:160px;" /> &nbsp;',
            '<input type="button" class="ke-upload-button" id="npLayBtnFile" value="' + lang.upload + '" /> &nbsp;',
            '<span class="ke-button-common ke-button-outer">',
            '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + lang.viewServer + '" />',
            '</span>',
            '</div>',
            ...
            layui.use('upload', function () {
                layui.upload.render({
                    ...
                    , done: function (res) {
                        ...
                        if (res.data && res.data.code === "000") {
                            K("input[data-url][name=url]").val(NP_Config.domain + res.data.item.url);
                        }
                    }
                });
            });
                        ...
                        if (allowUploadGraft) {
                            var callback = function (res) {
                                ...
                                if (res.code == "000") {
                                    ...
                                    clickFn.call(self, NP_Config.domain + res.item.url);
                                    self.hideDialog().focus();
                                } else {
            ...
            var dialog = self.createDialog({
                    ...
                    yesBtn: {
                        ...
                        click: function (e) {
                            ...
                            if (border === '' || border === '0') {
                                html += ' class="layui-table ' + zeroborder + '"';
                            }
                            if (borderColor !== '') {
